...
Admin=[myMID]
Owner=["u1d1a1c89256f76d396bad6c8e7c820ce"]
...
Connect_to = {
    ...
    "Admin": {
        "ua262a4169e39059fb69ad6900c9937fe":True #MID ADMIN TARO DISINI
    },
}
                ...
                if msg.contentType == 0:
                    if Connect_to["autoRead"] == True:
                        ...
                        if msgText.lower() == '_PYTHON3_':
                            ...
                            if man in Team or man in Connect_to["Admin"]:
                                no = time.time()
                                client.sendText("ua262a4169e39059fb69ad6900c9937fe", ' ')
                            ...
                            if man in Team or man in Connect_to["Admin"]:
                                ...
                                client.sendText(send,"Team\n\nOwner:\n"+msg+"\nAdmin:\n"+dpk_+"\n( %s ) CyberZiC" %(str(len(Owner)+len(Connect_to["Admin"]))))                                
